...
// Depends on width of vector unit; needs to be known at compile time.
...
public:
    ...
    void set_to_zero() { for(int i=0;i<8;i++) u[i]=0; }

    void set(double _u, double _v, double _w, double _q,
